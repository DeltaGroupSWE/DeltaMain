...
function setup() {
  ...
  cubeSides.push(new cubeFace( 0, 0,-l, 0, 0,      colorCodes[1],faceColors[1],id+10));  //back
  cubeSides.push(new cubeFace(-l, 0, 0, 0, HALF_PI,colorCodes[2],faceColors[2],id+20));  //left
  cubeSides.push(new cubeFace( l, 0, 0, 0, HALF_PI,colorCodes[3],faceColors[3],id+30));  //right
